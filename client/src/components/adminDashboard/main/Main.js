...
import { getTotalUsers, getTotalPosts, getTotalComments, getTotalLikes, getSpamPosts } from "../../../redux/actions/adminAction";
        ...
        <div className="main__cards">
          ...
          <div className="card_admin">
            ...
            <div className="card_inner_admin">
              ...
              <span className="font-bold text-title">{admin.spam_posts.length}</span>
            </div>
          </div>
